<%@ Page Title="Manage Account" Language="C#" MasterPageFile="~/Pages/Site.Master" AutoEventWireup="true" CodeBehind="Manage.aspx.cs" Inherits="etgarPlus.Account.Manage" %>

<%@ Register Src="~/Account/OpenAuthProviders.ascx" TagPrefix="uc" TagName="OpenAuthProviders" %>

<asp:Content ContentPlaceHolderID="left_column_Body" runat="server">
    <h2><%: Title %>.</h2>
